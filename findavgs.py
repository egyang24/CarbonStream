# -*- coding: utf-8 -*-
"""
Created on Mon Mar 02 11:39:34 2015
...
averages = np.zeros((len(list),17))
for i in range(len(list)):
    for j in range(17):
        averages[i,j] = np.mean(list[i][j])
        

#with open('averages.csv', 'wb') as csvfile:
#    avgwriter = csv.writer(csvfile,delimiter=',', quoting=csv.QUOTE_ALL)
#    avgwriter.writerow(averages)



with open('averages.txt', 'wb') as f:
